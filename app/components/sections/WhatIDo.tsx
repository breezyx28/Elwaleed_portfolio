...
const WhatIDo = () => {
  return (
    <section
      id="what-i-do"
      className="relative w-full md:h-screen h-full my-[40px]"
    >
      <div className="absolute lg:left-[-200px] md:left-[-100px] left-[-24px] w-screen md:h-screen h-full bg-[#F7F4FF]"></div>
      <div className="wrapper h-full relative flex flex-col justify-center md:py-[0px] py-[32px]">
        <div className="w-full flex flex-col md:gap-y-[0px] gap-y-[32px]">
